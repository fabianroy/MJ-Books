    ...
    return (
        <div className="flex flex-col gap-10 mx-10">
            ...
            <div data-aos="fade-left" className="flex gap-8 border rounded-2xl p-6">
                <div>
                    <img data-aos="zoom-out-right" className="w-96 h-auto rounded-lg" src={product1} draggable="false" alt="Dhuturar Shesh Chithi" />
                </div>
                <div>
                    ...
                    <p className="status mt-6 font-semibold">Status: <span className="text-green-600">Available</span></p>
                </div>
            </div>
            ...
            <div data-aos="fade-right" className="flex flex-row-reverse gap-8 border rounded-2xl p-6">
                <div>
                    <img data-aos="zoom-out-left" className="w-96 h-auto rounded-lg" src={product2} draggable="false" alt="Dhuturar Shesh Chithi" />
                </div>
                <div>
                    ...
                    <p className="status mt-6 font-semibold text-right">Status: <span className="text-green-600">Available</span></p>
                </div>
            </div>
        </div>
    );
